...
class TestConformanceTest(DeviceConformanceTests):
    ...
    def test_provisional_cluster(self):
        ...
        success, problems = self.check_conformance(ignore_in_progress_test_event_only_disallowed_for_certification=False, is_ci=False, allow_provisional_test_event_only_disallowed_for_certification=True)
        asserts.assert_true(success, "Unexpected failure parsing endpoint with provisional cluster and allow_provisional_test_event_only_disallowed_for_certification enabled")
